...
import { useLocation } from "react-router-dom";
  ...
  const EditSlider = () => {
    ...
    const [sliderForm, setSliderForm] = useState(data);
    ...
    //   dispatch(EditSliderData(sliderForm));
    }
        ...
        <Flex mt="30px">
          ...
          <Stack spacing={[1, 5]} direction={["column", "row"]}>
            ...
            <Checkbox
              ...
              colorScheme="orange"
              name="isnewPopular"
              checked={sliderForm.isnewPopular}
              onChange={handelChange}
            >
              New & Popular
            </Checkbox>
